        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbar">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <h6 class="navbarText font-weight-bolder mb-0">Dashboard / Liste des Commandes</h6>
                </nav>
                    ...
                    <div class="col-12">
                        <div class="card my-4">
                            ...
                            @if($livraisons->isEmpty())
                                <p>Aucune livraison reçue pour le moment.</p>
                            @else
                                <table class="table">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        @foreach($livraisons as $livraison)
                                            <tr>
                                                <td>{{ $livraison->fournisseur->name }}</td>
                                                ...
                                                <td>
                                                    <a href="{{ route('livraisons.pdf', $livraison->id) }}">
